  ...
  return (
    <div className="bg-informationBackground">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="p-3">
            <h3 className="text-black font-semibold">Total Rebate Unclaimed: <span>৳ NaN</span></h3>
            <h3 className="text-black font-semibold">Total Rebate Amount: <span>৳ NaN</span></h3>
          ...
          >
            ...
            {isAscending ? (
              ...
              >
                ...
                <th className="border border-gray-300 px-4 py-2">রিবেট</th>
                <th className="border border-gray-300 px-4 py-2">Rebate Amount</th>
