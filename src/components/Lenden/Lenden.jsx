          ...
          <table className="min-w-full border-collapse border border-gray-300">
            <thead className="hidden lg:table w-full ">
              <tr className="bg-table-gray text-sm">
                ...
                <th className="border border-gray-300 px-4 py-2">Deposit Method</th>
                <th className="border border-gray-300 px-4 py-2">Deposit Amount</th>
                <th className="border border-gray-300 px-4 py-2">বোনাস</th>
